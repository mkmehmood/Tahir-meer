...
const UR = {
siteName:'عرائیں ورلڈ کونسل',
siteTagline:'اتحاد | بااختیاریت | ترقی',
siteSubName:'بنوں ریجنل آرگنائزیشن',
heroBadge:'AWC میں خوش آمدید',
heroTitle:'عرائیں ورلڈ کونسل',
heroSub:'اپنی اگلی نسل کو بااختیار بنانا، اپنے ورثے پر فخر',
heroTagline:'عرائیں برادری کو عالمی سطح پر متحد کرنا — طاقت، اتحاد، ترقی',
heroAboutBtn:'ہمارے بارے میں',
heroEventsBtn:'خبریں اور تقریبات',
aboutLabel:'ہم کون ہیں',
aboutTitle:'عرائیں ورلڈ کونسل (AWC)',
aboutSubtitle:'فلاح، تعلیم اور بااختیاریت کے ذریعے خدمت',
aboutP1:'عرائیں ورلڈ کونسل ایک غیر سیاسی، فلاحی پلیٹ فارم ہے جو عالمی عرائیں برادری کو ترقی، اتحاد اور بااختیاریت کے ایک وژن کے تحت متحد کرنے کے لیے قائم کیا گیا ہے۔',
...
programsDesc:'ہم ذیل کے تمام منصوبوں پر کام کر رہے ہیں۔ ہمارا مقصد پوری عرائیں برادری کو تمام سہولیات فراہم کرنا ہے۔',
teamLabel:'ہماری ٹیم',
...
donateDesc:'کیا آپ عرائیں خاندان کی مدد کرنا چاہتے ہیں؟',
...
footerDesc:'عرائیں ورلڈ کونسل عالمی عرائیں برادری کو متحد کرتی ہے، نوجوانوں کو بااختیار بناتی ہے، تعلیم کو فروغ دیتی ہے اور دنیا بھر میں ترقی کے لیے مضبوط نیٹ ورک بناتی ہے۔',
footerCopy:'© 2026 عرائیں ورلڈ کونسل (AWC) — جملہ حقوق محفوظ ہیں۔',
...
pageBodyBlog:'AWC بلاگ میں خوش آمدید۔ عرائیں ورلڈ کونسل برادری کی تازہ ترین خبروں، کہانیوں اور اعلانات سے باخبر رہیں۔',
pageBodyHistory:'عرائیں ورلڈ کونسل عرائیں برادری کو عالمی سطح پر متحد کرنے کے وژن کے ساتھ قائم کی گئی۔ معمولی آغاز سے AWC کمیونٹی بااختیاریت اور ترقی کے لیے ایک عالمی تحریک بن گئی ہے۔',
pageBodyDocs:'عرائیں ورلڈ کونسل کی سرکاری دستاویزات، پالیسیاں اور رہنما اصول۔ تمام وسائل اراکین اور عوام کے لیے دستیاب ہیں۔',
...
donSub:'آپ کا عطیہ براہ راست عرائیں برادری کی مدد کرتا ہے۔',
...
memAppTitle:'رکنیت کی درخواست — عرائیں ورلڈ کونسل',
memAppSub:'ہمارے ساتھ شامل ہوں! عرائیں ورلڈ کونسل کے رکن بننے کے لیے نیچے فارم بھریں۔',
...
wBiz:'کاروباری',
wFree:'فری لانسر',
phFullName:'محمد علی عرائیں',
phFatherName:'محمد اکرم عرائیں',
phCnic:'XXXXX-XXXXXXX-X',
phWhatsapp:'+92XXXXXXXXXX',
...
export function t(key, lang) {
  ...
  // i18next returns the key itself when missing — preserve old EN fallback behaviour
  return val !== key ? val : (EN[key] || key);
}
